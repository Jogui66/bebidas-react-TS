...
export default function GenerateAI() {
  ...
  const { showNotification, generateRecipe, recipe, isGenereting } = useAppStore()
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="relative">
            ...
            <button 
              type="submit" 
              aria-label="Enviar"
              className={`cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2 ${isGenereting ? 'cursor-not-allowed opacity-50' : ''}`}
        ...
        {isGenereting && <p className="text-center animate-blink">Generando...</p>}
